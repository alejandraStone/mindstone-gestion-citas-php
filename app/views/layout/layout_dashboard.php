    ...
    <div class="flex flex-col lg:flex-row lg:items-start w-full gap-4 px-2 lg:px-8">
        ...
        <aside class="sidebar fixed flex flex-col top-0 left-0 w-full lg:static lg:w-[240px] h-full mt-20 lg:mt-10 p-4 gap-4 lg:translate-x-0 transform -translate-x-full transition-transform duration-300 bg-brand-100 z-45 rounded-xl border border-brand-200">
            ...
            <div class="bg-white rounded-xl shadow-md p-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                ...
                <a href="<?= BASE_URL ?>app/views/admin/dashboard.php" class="flex items-center text-brand-700 hover:text-brand-900 py-3 ml-2 transition-all duration-300 hover:translate-x-1 font-normal">
                    <svg
                ...
                <!--Create users -->
                <a href="<?= BASE_URL ?>app/views/admin/create_user.php" class="flex items-center text-brand-700 hover:text-brand-900 py-3 ml-2 transition-all duration-300 hover:translate-x-1 font-normal">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                ...
                <!--User list -->
                <a href="<?= BASE_URL ?>app/controllers/user_list_controller.php" class="flex items-center text-brand-700 hover:text-brand-900 py-3 ml-2 transition-all duration-300 hover:translate-x-1 font-normal">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none" viewBox="0 0 24 24"
                        stroke-width="1.5"
                ...
                <!--Add a class-->
                <a href="<?= BASE_URL ?>app/views/admin/add_a_class.php" class="flex items-center text-brand-700 hover:text-brand-900 py-3 ml-2 transition-all duration-300 hover:translate-x-1 font-normal">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                ...
                <!--Add a coach-->
                <a href="<?= BASE_URL ?>app/views/admin/add_coach.php" class="flex items-center text-brand-700 hover:text-brand-900 py-3 ml-2 transition-all duration-300 hover:translate-x-1 font-normal">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
            ...
            <div
                ...
                <!--Upload files-->
                <a href="<?= BASE_URL ?>app/controllers/upload_files_controller.php" class="flex items-center text-brand-700 hover:text-brand-900 py-3 ml-2 transition-all duration-300 hover:translate-x-1 font-normal">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
