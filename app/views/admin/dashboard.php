...
<main class="flex-1 lg:flex-col mt-10 mb-10">
    <!--Card del admin-->
    <div class="flex flex-row p-8 gap-4 mb-4 justify-between bg-brand-100 border border-brand-200 rounded-xl animate-fade-in">
        <div class="flex-1 flex flex-col justify-center pl-8">
            <h2 class="text-4xl md:text-5xl font-titulo text-brand-900 mb-2">Hi Admin,
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="cards-dashboard">
            ...
            <div class="flex flex-col justify-center">
                ...
                <span class="total-bookings text-4xl font-bold text-brand-700 leading-none mb-1"></span>
                <span class="booking-growth flex items-center font-medium text-sm"></span>
            </div>
        </div>
...
<script src="<?= BASE_URL ?>/public/js/modules/show_info_dashboard.js"></script>
