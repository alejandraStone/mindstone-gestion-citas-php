...
$specialities = Speciality::getAll();//llamo a la función de especialidades
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="bg-white shadow-lg rounded-2xl p-8 w-full max-w-2xl">
        ...
        <form id="add-coach-form" class="bg-brand-50 p-6 rounded-2xl shadow-lg max-w-xl mx-auto font-normal">
            ...
            <!-- Muestro las especialidades guardadas en la ddbb y envío los IDs de c/d especialidad -->
            <fieldset class="mb-6">
                <legend class="text-brand-800 font-semibold">Speciality:</legend>
                <?php foreach ($specialities as $speciality): ?>
                    <label class="block">
                        <input type="checkbox" name="speciality[]" value="<?= $speciality['id'] ?>"> <?= htmlspecialchars($speciality['name']) ?>
                    </label>
                <?php endforeach; ?>
            </fieldset>
